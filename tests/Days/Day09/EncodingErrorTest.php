...
class EncodingErrorTest extends TestCase
{
     ...
     * @test
     */
    public function sumBoundaryNumbersOfContiguousNumbersSummingToGivenNumber_returns_expected_result(): void
    {
        $sampleData = <<<NUMBERS
        35
        20
        ...
        $result = $this->encodingError->sumBoundaryNumbersOfContiguousNumbersSummingToGivenNumber($sampleData, 127);
