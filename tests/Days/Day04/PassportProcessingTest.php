...
class PassportProcessingTest extends TestCase
{
     ...
     * @test
     */
    public function solve_rejects_invalid_values(): void
    {
        $invalidPassportData = <<<PASSPORTS
        eyr:1972 cid:100
        ...
        $result = $this->passportProcessing->solvePart1($invalidPassportData, true);
     ...
     * @test
     */
    public function solve_accepts_valid_values(): void
    {
        $validPassportData = <<<PASSPORTS
        ...
        $result = $this->passportProcessing->solvePart1($validPassportData, true);
